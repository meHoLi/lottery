...
});define("appmsg/appmsgext.js",["appmsg/log.js","biz_wap/utils/ajax.js","rt/appmsg/getappmsgext.rt.js","biz_common/utils/monitor.js","biz_common/utils/wxgspeedsdk.js"],function(e){
"use strict";
function t(e){
function t(e){
for(var t=window.location.href,s=t.indexOf("?"),i=t.substr(s+1),n=i.split("&"),o=0;o<n.length;o++){
var _=n[o].split("=");
...
for(var r in e)e.hasOwnProperty(r)&&(d[r]=e[r]);
...
if(o.setAvg(112287,34,i),o.send(),a=!0,Math.random()>.1)return;
_.saveSpeeds({
uin:window.uin,
pid:675,
speeds:[{
...
var s=e("appmsg/log.js"),i=e("biz_wap/utils/ajax.js"),n=e("rt/appmsg/getappmsgext.rt.js"),o=e("biz_common/utils/monitor.js"),_=e("biz_common/utils/wxgspeedsdk.js"),a=void 0;
return{
getData:t
};
