...
if(ct("[Appmsg comment] get comment success"),p(),!et&&"5"===window.item_show_type){
var _=Date.now()-window.logs.pagetime.page_begin;
if(V.setAvg(112287,36,_),V.send(),et=!0,Math.random()>.1)return;
F.saveSpeeds({
uin:uin,
pid:675,
speeds:[{
...
O&&i(O)),0==pt?(ft=e.logo_url,yt=e.nick_name,t&&(It=[]),n=e.elected_comment,n&&n.length?(j(n,c,"elected"),
...
o=e.friend_comment,j(o,d,"friend"),o&&0==o.length&&m(O),t&&(bt.fdlist.innerHTML=""),
...
}()):(n=e.elected_comment,n&&n.length&&(j(n,c,"elected"),bt.list.appendChild(c))),
...
l(),console.log("------------------------",window.friend_comment_enabled),j([{
content:e,
nick_name:yt,
...
c&&c.length&&(window.device_is_pc&&(i(bt.myareaPC),i(bt.mylist),c=w(c)),j(c,d,"mine"),
...
l.time=h(l.create_time),l.status="",l.logo_url=l.logo_url||c,l.logo_url=-1!=l.logo_url.indexOf("wx.qlogo.cn")?l.logo_url.replace(/\/132$/,"/96"):l.logo_url,
...
l.report_elected=l.is_elected||0,l.report_friend=l.is_from_friend||0,l.scene=d,l.reply.reply_list.length>0&&(l.reply.reply_list[0].time=h(l.reply.reply_list[0].create_time),
...
J.os.ios&&e.data&&jt.indexOf(e.data)>-1&&(ht=!0);
}),nt.on(bt.input,"click",function(){
J.os.ios&&ht&&(bt.input.blur(),bt.input.focus(),ht=!1);
